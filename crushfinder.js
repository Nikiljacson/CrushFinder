...
// //   add login credentials to the 'users' table
//   const username = u_name.value;
//   const dob = u_dob.value;
//   const f1= fname1.value;
//   const f2= fname2.value;
//   const f3=fname3.value;
//   const f4=fname4.value;
//   const uzs=zodiacSign(user_day,user_month);
//   const res1=match_found;


// //   const email = 'myemail@example.com';
  
//   const sql = 'INSERT INTO userdata2(user_name,User_DOB,Friend1,Friend2,Friend3,Friend4,user_Zsign,result) VALUES (?,?,?,?,?,?,?,?)';
//   const values = [username,dob,f1,f2,f3,f4,uzs,res1];
  
//   connection.query(sql, values, (err, result) => {
//     if (err) throw err;
//     console.log(`Added login credentials for ${username} to the database.`);
//   });
